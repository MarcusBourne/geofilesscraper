...
pip install  playwright		 #automating web browser for end-to-end testing
python -m playwright install


"python scrape.py" to run
...
must have aws credentials in creds.txt file in this order "accesskey, secretkey"
